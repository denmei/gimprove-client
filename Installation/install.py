...
os.system("sudo pip3 install numpy==1.14.2")
os.system("sudo pip3 install twisted==18.4.0")
os.system("sudo apt-get install libatlas3-base")
os.system("sudo pip3 install matplotlib==2.1.1")
os.system("sudo pip3 install pandas==0.22.0")
os.system("sudo pip3 install pytz==2018.3")
os.system("sudo pip3 install requests==2.18.4")
os.system("sudo pip3 install cairocffi")
os.system("sudo pip3 install websocket-client==0.47.0")
os.system("sudo pip3 install boto3==1.7.23")
